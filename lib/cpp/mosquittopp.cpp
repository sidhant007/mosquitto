...
int mosquittopp::publishv(int *mid, const char *topic, const struct vec *buffers, int buffers_cnt, int qos, bool retain)
{
	return mosquitto_publishv(m_mosq, mid, topic, buffers, buffers_cnt, qos, retain);
}
