...
# Test whether a client sends a correct PUBLISHV to a topic with QoS 0 and no payload.

# The client should connect to port 1888 with keepalive=60, clean session set,
# and client id publishv-qos0-test-np
# The test will send a CONNACK message to the client with rc=0. Upon receiving
# the CONNACK and verifying that rc=0, the client should send a PUBLISHV message
...
rc = 1
keepalive = 60
connect_packet = mosq_test.gen_connect("publishv-qos0-test-np", keepalive=keepalive)
