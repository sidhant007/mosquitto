...
# Test whether a client sends a correct PUBLISHM consisting of 3 buffers to a topic with QoS 0.
...
rc = 1
keepalive = 60
connect_packet = mosq_test.gen_connect("publishm-qos0-test", keepalive=keepalive)
connack_packet = mosq_test.gen_connack(rc=0)

publish_packet = mosq_test.gen_publish("pub/qos0/test", qos=0, payload="message1message2message3")
